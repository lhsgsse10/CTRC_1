...
# Provided code for watermark insertion and extraction with improvements
import numpy as np
import pywt
from PIL import Image
...
watermarked_image.show(title='Watermarked Image')
extracted_watermark.show(title='Extracted Watermark')

# Display inline
original_image, watermarked_image, extracted_watermark

import matplotlib.pyplot as plt

# Display the images side by side with the updated results
...
# Extracted Watermark
plt.subplot(1, 4, 3)
plt.imshow(watermark_image_path, cmap='gray')
plt.title('Watermark logo Image')
plt.axis('off')
