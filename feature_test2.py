...
def insert_watermark(original_image_path, watermark_image_path, output_image_path, alpha=0.8):
...
def extract_watermark(watermarked_image_path, original_LL, keypoints, watermark_size, output_watermark_path, alpha=0.8):
    start_time = time.time()
...
# Insert watermark
original_LL, keypoints = insert_watermark(original_image_path, watermark_image_path, watermarked_image_path, alpha=0.8)

# Extract watermark
extract_watermark(watermarked_image_path, original_LL, keypoints, Image.open(watermark_image_path).size, extracted_watermark_path, alpha=0.8)
