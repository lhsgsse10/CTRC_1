...
def insert_watermark_multiple(original_image_path, watermark_image_path, output_image_path, num_keypoints=300, alpha=0.3):
...
def extract_watermark_multiple(watermarked_image_path, original_LL, keypoints, watermark_size, output_watermark_path, alpha=0.3):
    start_time = time.time()
...
# 워터마크 삽입
original_LL, selected_keypoints = insert_watermark_multiple(original_image_path, watermark_image_path, watermarked_image_path, num_keypoints=300, alpha=0.3)

# 워터마크 추출
extract_watermark_multiple(watermarked_image_path, original_LL, selected_keypoints, Image.open(watermark_image_path).size, extracted_watermark_path, alpha=0.3)
