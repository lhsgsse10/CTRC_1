...
def insert_watermark_sift_region(original_image_path, watermark_image_path, output_image_path, region_size=32, alpha=0.15):
    ...
    return x_start, y_start, x_end, y_end, kp, watermarked_image_data
...
# 워터마크 삽입
x_start, y_start, x_end, y_end, kp, watermarked_image_data = insert_watermark_sift_region(original_image_path, watermark_image_path, watermarked_image_path)
